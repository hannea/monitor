...
#' Count and plot alarms using a spline, assuming heterogeneous variance
#'
...
#' means and two splines are fitted to the three sigma above and below the means, respectively.
...
#'
#' @return  A count of the number of alarms, alarm rate, and residuals. Furthermore a plot is
